...
<form method="POST" action="/api/Departments">
    ...
    <label for="amountOfUsedCoffeeCups">amountOfUsedCoffeeCups:</label><br>
    <input type="number" id="amountOfUsedCoffeeCups" name="amountOfUsedCoffeeCups"><br>
...
<script>
    ...
    let fetchResColleagues = fetch('/api/Colleagues/1');

    fetchResColleagues.then(res => res.json().then(json => generateLabel(json, "resultColleagues")));
